...
#' @param f a gar_api_generator function
#' @param walk_vector a vector of the parameter to change
#' @param pars default pars_arguments list
#' @param path default path_arguments list
#' @param pars_walk the parameter to modify for each walk
#' @param path_walk the path to modify for each walk
#' @param batch_size size of each request to Google API
#' 
