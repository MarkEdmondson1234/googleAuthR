...
If you supply a filename to `googleAuthR::gar_auth(token = "filename")` then it will save the token there.  If it doesn't exisit, it will make a new one, if it does exist it will attempt to read the token from that file.  
