...
## Example Shiny app
An example shiny app with Google authentication is [deployed to shinyapps.io here](https://mark.shinyapps.io/googleAuthRexample/).   

It uses the example app that is available in `system.file("shiny", package="googleAuthR")`

## Example RMarkdown app

From `v4` the authentication flow also works in RMarkdown documents, by using JavaScript instead of R/Shiny to talk with Google servers.

A how-to and example is available at this RMarkdown document: `https://mark.shinyapps.io/googleAuthRMarkdown/`
